...
public class DemoRequestUtils {
    ...
    private static final String TAG ="adbidSdk";
    protected static final String SERVER_BIDDING_URL = "http://ads-bid.leadmoad.com/api/adx/bidding";
           ...
           @Override public void onInfoCallback(String sdkInfo) {
               new Thread(){
                   ...
                   public void run() {
                       super.run();
                       try {
                           Logger.i("loadSplash","token: "+sdkInfo);
